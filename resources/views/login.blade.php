  ...
  <body class = "formulario">
    ...
    <div class = "contenedor">
        ...
        <div class = "login">
          ...
          <div>
            <button name = "registerbtn" type="button" class="btn btn-secondary">Iniciar Sesión</button>
          </div>

          <p>Al registrarte, aceptas nuestras Condiciones de uso y Política de privacidad.</p>
          <p>¿No tienes cuenta?<a class="link" href="register.blade.php">Crear Cuenta</a></p>
